...
if (Parameter.Mod_Motor.Aktiv == 0)&&(Parameter.Mod_Insassen.Aktiv == 1)
    % Korrektur Gesamtdimension
    Parameter.Gesamtdimension = Parameter.Gesamtdimension+Parameter.Mod_Insassen.Dimension;
    % Schreiben Wert für Indizes kankan
    Parameter.Mod_Insassen.idx = Parameter.Gesamtdimension-Parameter.Mod_Insassen.Dimension+1:Parameter.Gesamtdimension;
...
elseif (Parameter.Mod_Motor.Aktiv == 1)&&(Parameter.Mod_Insassen.Aktiv == 1)
    ...
    Parameter.Gesamtdimension = Parameter.Gesamtdimension+Parameter.Mod_Insassen.Dimension;
    % Schreiben Wert für Indizes kankan
    Parameter.Mod_Insassen.idx = Parameter.Gesamtdimension-Parameter.Mod_Insassen.Dimension-Parameter.Mod_Motor.Dimension+1:Parameter.Gesamtdimension-Parameter.Mod_Motor.Dimension;
...
elseif (Parameter.Mod_Motor.Aktiv == 1)&&(Parameter.Mod_Insassen.Aktiv == 0)
...
disp(Parameter.Mod_Insassen.Aktiv)
